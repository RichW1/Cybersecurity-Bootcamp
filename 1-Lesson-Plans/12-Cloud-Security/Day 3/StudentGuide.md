...
- This activity can also be skipped if you need more time to complete all of the previous steps thus far.
...
- In the next activity, you will continue to configure your Red Team cloud setup by configuring a new VM to add to the load balancer backend pool.
